  ...
  public partial class ButtonBaseControl : DataFilterBaseControl
  {
...
#if !FRCORE 
        (DrawControl as ButtonBase).AutoSize = value; 
#endif
      }
    }
    ...
    public Image Image
    {
      ...
      { 
        Button.Image = value;
#if !FRCORE
        (DrawControl as ButtonBase).Image = value; 
#endif
      }
    }
...
#if !FRCORE
        (DrawControl as ButtonBase).ImageAlign = value; 
#endif
      }
    }
...
#if !FRCORE
        (DrawControl as ButtonBase).TextAlign = value;
#endif
      }
    }
...
#if !FRCORE
        (DrawControl as ButtonBase).TextImageRelation = value; 
#endif
      }
    }
#endregion
