...
namespace FastReport.Export.Hpgl
{
    ...
    public partial class HpglExport : ExportBase
    {
        #region Fields
        ...
        private IGraphics hpglMeasureGraphics;
        ...
        /// <summary>
        /// Gets or sets lines/polygons gap for barcodes object 
        /// </summary>
        public float BarcodesGap
        {
            get { return barcodesGap; }
            set { barcodesGap = value; }
        }

        /// <summary>
        /// Gets or sets the hpgl objects fill mode
        /// </summary>
        public HpglFillMode FillMode
        {
            get { return fillMode; }
            set { fillMode = value; }
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HpglExport"/> class.
        /// </summary>
        public HpglExport()
        {
            hpglDocument = new HpglDocument();
            HasMultipleFiles = true;
            hpglMeasureGraphics = new GdiGraphics(new Bitmap(1, 1));
        }
        ...
        {
            string hpglString = hpglDocument.ToString();
            File.WriteAllText(filename, hpglString);
        }
        ...
        {
            string hpglString = hpglDocument.ToString();
            byte[] encodedDfx = Encoding.UTF8.GetBytes(hpglString);
        ...
        protected override void ExportPageBegin(ReportPage page)
        {
            ...
            hpglDocument = new HpglDocument();
            hpglDocument.Start(new SizeF(4000, 4000));
            // page borders
            if (page.Border.Lines != BorderLines.None)
            {
                using (TextObject pageBorder = new TextObject())
                {
                    ...
                    pageBorder.Left = 0;
                    pageBorder.Top = 0;
                    pageBorder.Width = (pageWidth - page.LeftMargin - page.RightMargin);
        ...
        {
            return new MyRes("FileFilters").Get("HpglFile");
        }
        #endregion
