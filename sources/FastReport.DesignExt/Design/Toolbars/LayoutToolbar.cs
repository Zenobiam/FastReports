...
namespace FastReport.Design.Toolbars
{
    internal class LayoutToolbar : ToolbarBase
    {
...
#else
        public ToolStripButton btnAlignToGrid;
        ...
        public ToolStripButton btnSameWidth;
        public ToolStripButton btnSameHeight;
        public ToolStripButton btnSameSize;
        public ToolStripButton btnSizeToGrid;
        public ToolStripButton btnSpaceHorizontally;
        public ToolStripButton btnIncreaseHorizontalSpacing;
        public ToolStripButton btnDecreaseHorizontalSpacing;
        public ToolStripButton btnRemoveHorizontalSpacing;
        public ToolStripButton btnSpaceVertically;
        public ToolStripButton btnIncreaseVerticalSpacing;
        public ToolStripButton btnDecreaseVerticalSpacing;
        public ToolStripButton btnRemoveVerticalSpacing;
        public ToolStripButton btnCenterHorizontally;
        public ToolStripButton btnCenterVertically;
        public ToolStripButton btnBringToFront;
        public ToolStripButton btnSendToBack;
#endif
        #endregion
        ...
        {
            base.ReinitDpiSize();
            btnAlignToGrid.Image = Res.GetImage(98);
            btnSizeToGrid.Image = Res.GetImage(57);
            btnLeft.Image = Res.GetImage(41);
            btnCenter.Image = Res.GetImage(42);
            btnRight.Image = Res.GetImage(45);
            btnTop.Image = Res.GetImage(46);
            btnMiddle.Image = Res.GetImage(47);
            btnBottom.Image = Res.GetImage(50);
            btnSameWidth.Image = Res.GetImage(83);
            btnSameHeight.Image = Res.GetImage(84);
            btnSameSize.Image = Res.GetImage(91);
            btnSpaceHorizontally.Image = Res.GetImage(44);
            btnIncreaseHorizontalSpacing.Image = Res.GetImage(92);
            btnDecreaseHorizontalSpacing.Image = Res.GetImage(93);
            btnRemoveHorizontalSpacing.Image = Res.GetImage(94);
            btnSpaceVertically.Image = Res.GetImage(49);
            btnIncreaseVerticalSpacing.Image = Res.GetImage(95);
            btnDecreaseVerticalSpacing.Image = Res.GetImage(96);
            btnRemoveVerticalSpacing.Image = Res.GetImage(97);
            btnCenterHorizontally.Image = Res.GetImage(43);
            btnCenterVertically.Image = Res.GetImage(48);
            btnBringToFront.Image = Res.GetImage(14);
            btnSendToBack.Image = Res.GetImage(15);
        }
        #endregion
        ...
        btnAlignToGrid, btnSizeToGrid, new ToolStripSeparator(),
        btnLeft, btnCenter, btnRight, new ToolStripSeparator(),
        btnTop, btnMiddle, btnBottom,  new ToolStripSeparator(),
        btnSameWidth, btnSameHeight, btnSameSize,  new ToolStripSeparator(),
        btnSpaceHorizontally, btnIncreaseHorizontalSpacing, btnDecreaseHorizontalSpacing, btnRemoveHorizontalSpacing, new ToolStripSeparator(),
        btnSpaceVertically, btnIncreaseVerticalSpacing, btnDecreaseVerticalSpacing, btnRemoveVerticalSpacing, new ToolStripSeparator(),
        btnCenterHorizontally, btnCenterVertically,  new ToolStripSeparator(),
