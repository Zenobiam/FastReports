...
namespace FastReport.Map.Forms
{
  internal partial class LayerEditorControl : UserControl
  {
    ...
    private void Init()
    {
      ...
      tbSpatialValue.ImageIndex = 52;
      tbAnalyticalValue.ImageIndex = 52;
      tbFilter.ImageIndex = 52;
      tbLatitudeValue.ImageIndex = 52;
      tbLongitudeValue.ImageIndex = 52;
      tbLabelValue.ImageIndex = 52;
      tbZoomPolygon.ImageIndex = 52;
