...
namespace FastReport.Forms
{
  partial class ReportOptionsForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.cbSavePreviewPicture = new ScalableCheckBox();
      ...
      this.rbVB = new ScalableRadioButton();
      this.rbC = new ScalableRadioButton();
      this.lblPassword = new System.Windows.Forms.Label();
      this.tbRetypePassword = new System.Windows.Forms.TextBox();
      this.tbPassword = new System.Windows.Forms.TextBox();
      this.lblRetypePassword = new System.Windows.Forms.Label();
      this.btnBrowse = new System.Windows.Forms.Button();
      this.rbInherit = new ScalableRadioButton();
      this.rbDetach = new ScalableRadioButton();
      this.rbDontChange = new ScalableRadioButton();
      ...
      this.cbDoublePass = new ScalableCheckBox();
      this.cbConvertNulls = new ScalableCheckBox();
      this.cbCompress = new ScalableCheckBox();
      this.cbSmoothGraphics = new ScalableCheckBox();
      this.cbUseFileCache = new ScalableCheckBox();
      ...
      this.pnInheritance.Controls.Add(this.lblChooseInheritance);
            this.lblChooseInheritance.BringToFront();
