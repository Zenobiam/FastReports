...
namespace FastReport.Forms
{
  partial class StyleEditorForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.cbApplyBorder = new ScalableCheckBox();
      this.cbApplyFill = new ScalableCheckBox();
      this.cbApplyFont = new ScalableCheckBox();
      this.cbApplyTextFill = new ScalableCheckBox();
