...
namespace FastReport.Forms
{
  partial class PrinterSetupForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.cbSavePrinter = new ScalableCheckBox();
      this.cbPrintToFile = new ScalableCheckBox();
      this.btnSettings = new System.Windows.Forms.Button();
      this.gbPageRange = new System.Windows.Forms.GroupBox();
      this.lblHint = new System.Windows.Forms.Label();
      this.tbNumbers = new System.Windows.Forms.TextBox();
      this.rbNumbers = new ScalableRadioButton();
      this.rbCurrent = new ScalableRadioButton();
      this.rbAll = new ScalableRadioButton();
      this.gbCopies = new System.Windows.Forms.GroupBox();
      this.pnCollate = new System.Windows.Forms.Panel();
      this.cbCollate = new ScalableCheckBox();
