    ...
    public ConfigureBandsForm(Designer designer)
    {
        ...
        public override void CheckRtl()
        {
            ...
            if (Config.RightToLeft)
            {
                ...
                btnUp.Anchor = AnchorStyles.Top | AnchorStyles.Left;
                btnDown.Left = ClientSize.Width - btnDown.Left - btnDown.Width;
                btnDown.Anchor = AnchorStyles.Top | AnchorStyles.Left;
        ...
        {
            tvBands.ImageList = Res.GetImages(FormRatio);

            mnuBands.ImageScalingSize = new Size((int)(16 * FormRatio), (int)(16 * FormRatio));
            ...
            miDelete.Font = ParseFontSize(miDelete.Font, 9);
            btnUp.Font = ParseFontSize(miDelete.Font, 9);
            btnDown.Font = ParseFontSize(miDelete.Font, 9);
            miPageHeader.Font = ParseFontSize(miDelete.Font, 9);
            miReportTitle.Font = ParseFontSize(miDelete.Font, 9);
            miColumnHeader.Font = ParseFontSize(miDelete.Font, 9);
            miDataHeader.Font = ParseFontSize(miDelete.Font, 9);
            miData.Font = ParseFontSize(miDelete.Font, 9);
            miGroup.Font = ParseFontSize(miDelete.Font, 9);
            miDataFooter.Font = ParseFontSize(miDelete.Font, 9);
            miGroupFooter.Font = ParseFontSize(miDelete.Font, 9);
            miColumnFooter.Font = ParseFontSize(miDelete.Font, 9);
            miReportSummary.Font = ParseFontSize(miDelete.Font, 9);
            miPageFooter.Font = ParseFontSize(miDelete.Font, 9);
            miChild.Font = ParseFontSize(miDelete.Font, 9);
            miOverlay.Font = ParseFontSize(miDelete.Font, 9);
        }
#endif
    }
}
