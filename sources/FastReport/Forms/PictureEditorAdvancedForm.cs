...
{
    internal partial class PictureEditorAdvancedForm : ScaledSupportingForm
    {
        public Image Image
        {
            get
        ...
        {
            base.Scale();
            Panel pr = panelBottom;
            btnCancel.Location = new Point(panelBottom.Width - btnCancel.Width - DpiHelper.ConvertUnits(13), panelBottom.Height / 2 - btnCancel.Height / 2);
            btnReset.Location = new Point(btnCancel.Left - DpiHelper.ConvertUnits(10) - btnReset.Width, btnCancel.Location.Y);
            btnOK.Location = new Point(btnReset.Left - DpiHelper.ConvertUnits(10) - btnOK.Width, btnCancel.Location.Y);
            lblSize.Font = new Font(lblSize.Font.Name, 9 * FormRatio * 96f / DpiHelper.BaseDpi, lblSize.Font.Style);// DpiHelper.ConvertUnits(lblSize.Font, true);
        }
#endif
    }
