  ...
  internal partial class PageSetupForm : BaseDialogForm
  {
    ...
    private void UpdateControls()
    {
      ...
      foreach (PaperSource ps in printerSettings.PaperSources)
      {
        ...
        cbxLastPage.Items.Add(ps.SourceName);
        ...
        if (Page.LastPageSource == ps.RawKind)
          cbxLastPage.SelectedIndex = cbxLastPage.Items.Count - 1;
      }
      ...
      if (cbxLastPage.SelectedIndex == -1 && cbxLastPage.Items.Count > 0)
        cbxLastPage.SelectedIndex = indexOfAutofeed;
    ...
    {
      if (updating || cbxPaper.SelectedIndex == 0)
        return;
      foreach (PaperSize ps in printerSettings.PaperSizes)
      {
    ...
    {
#if !MONO
      using (Bitmap bmp = GetBitmap(rbPortrait.Checked ? "portrait.png" : "landscape.png"))
#else
    ...
    private void UpdatePage()
    {
      ...
      Page.RawPaperSize = cbxPaper.SelectedIndex == 0 ? 0 : printerSettings.PaperSizes[cbxPaper.SelectedIndex - 1].RawKind;
      ...
      {
        Page.FirstPageSource = printerSettings.PaperSources[cbxFirstPage.SelectedIndex].RawKind;
        Page.OtherPagesSource = printerSettings.PaperSources[cbxOtherPages.SelectedIndex].RawKind;
        Page.LastPageSource = printerSettings.PaperSources[cbxLastPage.SelectedIndex].RawKind;
      }
    ...
    public override void Localize()
    {
      ...
      lblLastPage.Text = res.Get("LastPage");
      ...
      cbUnlimitedHeight.Text = res.Get("UnlimitedHeight");
        ...
        public override void CheckRtl()
        {
            ...
            if (Config.RightToLeft)
            {
                ...
                lblLastPage.Left = pnSource.Width - lblLastPage.Left - lblLastPage.Width;
                lblLastPage.Anchor = (AnchorStyles.Top | AnchorStyles.Right);
