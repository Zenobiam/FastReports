...
namespace FastReport.Messaging.Xmpp
{
    ...
    public partial class XmppMessengerForm : MessengerForm
    {
        ...
        public XmppMessengerForm(string jidFrom, string password, string jidTo, Report report)// : base(report)
        {
            ...
            tbJidTo.Text = jidTo;
            pageControl1.Height += DpiHelper.ConvertUnits(40);
        }
        ...
        public override void CheckRtl()
        {
            ...
            if (Config.RightToLeft)
            {
                ...
                labelJidFrom.Left = pgFile.Width - labelJidFrom.Width - (int)(CurrentDpi * 16);
                labelJidFrom.Anchor = (AnchorStyles.Top | AnchorStyles.Right);
                labelPassword.Left = pgFile.Width - labelPassword.Width - (int)(CurrentDpi * 16);
                labelPassword.Anchor = (AnchorStyles.Top | AnchorStyles.Right);
                labelJidTo.Left = pgFile.Width - labelJidTo.Width - (int)(CurrentDpi * 16);
            ...
            labelCloudWarning.Height = pgFile.Height - labelCloudWarning.Top;
        }
