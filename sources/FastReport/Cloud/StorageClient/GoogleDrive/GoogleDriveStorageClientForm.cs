...
namespace FastReport.Cloud.StorageClient.GoogleDrive
{
    ...
    /// </summary>
    public partial class GoogleDriveStorageClientForm : CloudStorageClientForm
    {
        #region Fields

        private GoogleDriveStorageClient client;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GoogleDriveStorageClientForm"/> class.
        /// </summary>
        public GoogleDriveStorageClientForm() : base()
        {
        ...
        public GoogleDriveStorageClientForm(ClientInfo clientInfo, Report report) : base(report)
        {
            //client = new GoogleDriveStorageClient(clientInfo);
        ...
        public override void Localize()
        {
            ...
            MyRes res = new MyRes("Cloud,GoogleDrive");
            this.Text = res.Get("");
        }
