...
namespace FastReport.Dialog
{
  ...
  /// </summary>
  public partial class GridControl : DialogControl, IParent
  {
    ...
    public bool AllowUserToAddRows
    {
      ...
      set { DataGridView.AllowUserToAddRows = value; (DrawControl as DataGridView).AllowUserToAddRows = value; }
    }
    ...
    public bool AllowUserToDeleteRows
    {
      ...
      set { DataGridView.AllowUserToDeleteRows = value; (DrawControl as DataGridView).AllowUserToDeleteRows = value; }
    }
    ...
    public DataGridViewCellStyle AlternatingRowsDefaultCellStyle
    {
      ...
      set { DataGridView.AlternatingRowsDefaultCellStyle = value; (DrawControl as DataGridView).AlternatingRowsDefaultCellStyle = value; }
    }
    ...
    public DataGridViewAutoSizeColumnsMode AutoSizeColumnsMode
    {
      ...
      set { DataGridView.AutoSizeColumnsMode = value; (DrawControl as DataGridView).AutoSizeColumnsMode = value; }
    }
    ...
    public DataGridViewAutoSizeRowsMode AutoSizeRowsMode
    {
      ...
      set { DataGridView.AutoSizeRowsMode = value; (DrawControl as DataGridView).AutoSizeRowsMode = value; }
    }
    ...
    public Color BackgroundColor
    {
      ...
      set { DataGridView.BackgroundColor = value; (DrawControl as DataGridView).BackgroundColor = value; }
    }
    ...
    public BorderStyle BorderStyle
    {
      ...
      set { DataGridView.BorderStyle = value; (DrawControl as DataGridView).BorderStyle = value; }
    }
    ...
    public DataGridViewCellBorderStyle CellBorderStyle 
    {
      ...
      set { DataGridView.CellBorderStyle = value; (DrawControl as DataGridView).CellBorderStyle = value; }
    }
    ...
    public DataGridViewHeaderBorderStyle ColumnHeadersBorderStyle
    {
      ...
      set { DataGridView.ColumnHeadersBorderStyle = value; (DrawControl as DataGridView).ColumnHeadersBorderStyle = value; }
    }
    ...
    {
      get { if((DrawControl as DataGridView).ColumnHeadersDefaultCellStyle != DataGridView.ColumnHeadersDefaultCellStyle) (DrawControl as DataGridView).ColumnHeadersDefaultCellStyle = DataGridView.ColumnHeadersDefaultCellStyle; return DataGridView.ColumnHeadersDefaultCellStyle; }
      set { DataGridView.ColumnHeadersDefaultCellStyle = value; (DrawControl as DataGridView).ColumnHeadersDefaultCellStyle = value; }
    }
    ...
    public int ColumnHeadersHeight
    {
      ...
      set { DataGridView.ColumnHeadersHeight = value; (DrawControl as DataGridView).ColumnHeadersHeight = DpiHelper.ConvertUnits(value); }
    }
    ...
    public DataGridViewColumnHeadersHeightSizeMode ColumnHeadersHeightSizeMode 
    {
      ...
      set { DataGridView.ColumnHeadersHeightSizeMode = value; (DrawControl as DataGridView).ColumnHeadersHeightSizeMode = value; }
    }
    ...
    public bool ColumnHeadersVisible
    {
      ...
      set { DataGridView.ColumnHeadersVisible = value; (DrawControl as DataGridView).ColumnHeadersVisible = value; }
    }
    ...
    [Category("Data")]
    [Editor("FastReport.TypeEditors.GridControlColumnsEditor, FastReport", typeof(UITypeEditor))]
    ...
    public DataGridViewCellStyle DefaultCellStyle
    {
      ...
      set { DataGridView.DefaultCellStyle = value; (DrawControl as DataGridView).DefaultCellStyle = value; }
    }
    ...
    public Color GridColor
    {
      ...
      set { DataGridView.GridColor = value; (DrawControl as DataGridView).GridColor = value; }
    }
    ...
    public bool MultiSelect
    {
      ...
      set { DataGridView.MultiSelect = value; (DrawControl as DataGridView).MultiSelect = value; }
    }
    ...
    public bool ReadOnly
    {
      ...
      set { DataGridView.ReadOnly = value; (DrawControl as DataGridView).ReadOnly = value; }
    }
    ...
    public DataGridViewHeaderBorderStyle RowHeadersBorderStyle
    {
      ...
      set { DataGridView.RowHeadersBorderStyle = value; (DrawControl as DataGridView).RowHeadersBorderStyle = value; }
    }
    ...
    public DataGridViewCellStyle RowHeadersDefaultCellStyle
    {
      ...
      set { DataGridView.RowHeadersDefaultCellStyle = value; (DrawControl as DataGridView).RowHeadersDefaultCellStyle = value; }
    }
    ...
    public bool RowHeadersVisible
    {
      ...
      set { DataGridView.RowHeadersVisible = value; (DrawControl as DataGridView).RowHeadersVisible = value; }
    }
    ...
    public int RowHeadersWidth
    {
      ...
      set { DataGridView.RowHeadersWidth = value; (DrawControl as DataGridView).RowHeadersWidth = DpiHelper.ConvertUnits(value); }
    }
    ...
    public DataGridViewRowHeadersWidthSizeMode RowHeadersWidthSizeMode
    {
      ...
      set { DataGridView.RowHeadersWidthSizeMode = value; (DrawControl as DataGridView).RowHeadersWidthSizeMode = value; }
    }
    ...
    public DataGridViewCellStyle RowsDefaultCellStyle
    {
      ...
      set { DataGridView.RowsDefaultCellStyle = value; (DrawControl as DataGridView).RowsDefaultCellStyle = value; }
    }
    ...
    public ScrollBars ScrollBars
    {
      ...
      set { DataGridView.ScrollBars = value; (DrawControl as DataGridView).ScrollBars = value; }
    }
    ...
    public DataGridViewSelectionMode SelectionMode
    {
      ...
      set { DataGridView.SelectionMode = value; (DrawControl as DataGridView).SelectionMode = value; }
    }
      ...
      DataGridViewCellStyle style, DataGridViewCellStyle diff)
    {
      ...
      if (style.Font != null && ((writer.SerializeTo != SerializeTo.Preview || !style.Font.Equals(diff.Font))) && writer.ItemName != "inherited")
    ...
    public override void FinalizeControl()
    {
      ...
      DataGridView.DataSource = null;
        ...
        {
            (DrawControl as DataGridView).Columns.Clear();
            foreach (DataGridViewColumn Col in DataGridView.Columns)
                (DrawControl as DataGridView).Columns.Add((DataGridViewColumn)Col.Clone());

            for(int i = 0; i < (DrawControl as DataGridView).Columns.Count; i++)//each(DataGridViewColumn column in (DrawControl as DataGridView).Columns)
            {
                (DrawControl as DataGridView).Columns[i].Width = DpiHelper.ConvertUnits(dataGridView.Columns[i].Width);
            }
            base.Draw(e);
        }
        ...
        public GridControl()
    {
      ...
      columns = new GridControlColumnCollection(this);
      ...
      DataGridView.AlternatingRowsDefaultCellStyle.BackColor = Color.WhiteSmoke;
            ...
            DrawControl = new DataGridView();
            (DrawControl as DataGridView).AutoGenerateColumns = false;
            (DrawControl as DataGridView).AllowUserToAddRows = false;
            (DrawControl as DataGridView).AllowUserToDeleteRows = false;
            (DrawControl as DataGridView).ReadOnly = true;
            (DrawControl as DataGridView).AlternatingRowsDefaultCellStyle.BackColor = Color.WhiteSmoke;
