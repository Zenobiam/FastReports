...
namespace FastReport.Dialog
{
  ...
  /// </summary>
  public partial class ListViewControl : DialogControl
  {
    private ListView listView;
    private string itemCheckedEvent;
    ...
    public bool CheckBoxes
    {
      ...
      set { ListView.CheckBoxes = value; (DrawControl as ListView).CheckBoxes = value; }
    }
    ...
    public bool MultiSelect
    {
      ...
      set { ListView.MultiSelect = value; (DrawControl as ListView).MultiSelect = value; }
    }
    ...
    public bool ShowGroups
    {
      ...
      set { ListView.ShowGroups = value; (DrawControl as ListView).ShowGroups = value; }
    }
    ...
    public View View
    {
      ...
      set { ListView.View = value; (DrawControl as ListView).View = value; }
    }
    ...
    {
      get { return itemCheckedEvent; }
      set { itemCheckedEvent = value; }
    }
    ...
    public ImageList LargeImageList
    {
      ...
      set { ListView.LargeImageList = value; (DrawControl as ListView).LargeImageList = value; }
    }
    ...
    public ImageList SmallImageList
    {
      ...
      set { ListView.SmallImageList = value; (DrawControl as ListView).SmallImageList = value; }
    }
    #endregion
    ...
    public ListViewControl()
    {
      ...
      ListView.HideSelection = false;
            ...
            DrawControl = new ListView();
            (DrawControl as ListView).HideSelection = false;
