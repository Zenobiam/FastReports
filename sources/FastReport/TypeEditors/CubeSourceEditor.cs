...
namespace FastReport.TypeEditors
{
  ...
  /// </summary>
  internal class CubeSourceEditor : UITypeEditor
  {
    ...
    {
      if (e.Node.Tag is CubeSourceBase || e.Node.Tag == null)
        edSvc.CloseDropDown();
    }
