...
namespace FastReport.Forms
{
    ...
    public partial class TextExportForm : BaseExportForm
    {
        ...
        {
            base.Scale();
            tbPreview.Width = Width - picPerforation.Right - SystemInformation.VerticalScrollBarWidth;
            tbPreview.Height = ClientSize.Height - toolStrip.Height - Status.Height;
            picPerforation.Height = ClientSize.Height - toolStrip.Height - Status.Height;
        }
